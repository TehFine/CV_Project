...
async function bootstrap() {
  ...
  const mockJobs = [
    ...
    // ── 10 tin mới – đa công ty và lĩnh vực ──
    {
      ...
      description: 'VinBigData tìm kiếm Data Analyst có khả năng phân tích dữ liệu lớn, xây dựng dashboard và hỗ trợ ra quyết định kinh doanh. Bạn sẽ làm việc cùng các kỹ sư ML và đội ngũ sản phẩm trong môi trường dữ liệu quy mô lớn.',
      requirements: ['Thành thạo Python và SQL', 'Kinh nghiệm với Power BI hoặc Tableau', 'Tư duy phân tích tốt', 'Ít nhất 1 năm kinh nghiệm DA'],
      benefits: ['Lương tháng 13', 'BHYT nâng cao', 'Làm việc với dữ liệu thực quy mô triệu bản ghi'],
      status: 'active',
      featured: true
    },
    {
      ...
      description: 'FPT Software tuyển DevOps Engineer phụ trách xây dựng hạ tầng cloud, tự động hóa CI/CD và giám sát hệ thống cho các dự án outsource quy mô quốc tế. Cơ hội làm việc với khách hàng Nhật Bản, Mỹ, Châu Âu.',
      requirements: ['Ít nhất 3 năm kinh nghiệm DevOps', 'Thành thạo Docker và Kubernetes', 'Kinh nghiệm AWS/GCP/Azure', 'Hiểu biết về IaC (Terraform, Ansible)'],
      benefits: ['Onsite nước ngoài', 'Lương thưởng dự án', 'Chứng chỉ AWS được hỗ trợ chi phí'],
      status: 'active',
      featured: false
    },
    {
      ...
      type: 'Full-time',
      level: 'Senior',
      tags: ['SEO', 'SEM', 'Google Ads', 'Facebook Ads', 'Content Marketing', 'Analytics'],
      description: 'Shopee Vietnam tìm kiếm Digital Marketing Manager để lên chiến lược và triển khai các chiến dịch quảng cáo online cho thương hiệu. Bạn sẽ quản lý ngân sách marketing, phân tích hiệu quả chiến dịch và dẫn dắt team marketing khoảng 8 người.',
      requirements: ['Ít nhất 4 năm kinh nghiệm Digital Marketing', 'Thành thạo Google Ads và Facebook Ads', 'Kỹ năng phân tích dữ liệu (Google Analytics, Mixpanel)', 'Kinh nghiệm quản lý team'],
      benefits: ['Stock options', 'Ngân sách học tập 20 triệu/năm', 'Môi trường startup quốc tế'],
      status: 'active',
      featured: true
    },
    {
      ...
      description: 'Vinamilk tuyển Kế Toán Tổng Hợp phụ trách hạch toán kế toán, lập báo cáo tài chính định kỳ, kê khai thuế và hỗ trợ kiểm toán nội bộ. Đây là vị trí quan trọng trong bộ máy tài chính của tập đoàn.',
      requirements: ['Tốt nghiệp chuyên ngành Kế toán / Kiểm toán / Tài chính', 'Thành thạo phần mềm MISA hoặc SAP', 'Kinh nghiệm ít nhất 2 năm', 'Chứng chỉ kế toán viên là lợi thế'],
      benefits: ['Lương tháng 13 + thưởng KPI', 'BHXH đầy đủ', 'Phụ cấp ăn trưa'],
      status: 'active',
      featured: false
    },
    {
      ...
      type: 'Full-time',
      level: 'Senior',
      tags: ['Product Management', 'Agile', 'Scrum', 'User Research', 'Fintech', 'OKR'],
      description: 'MoMo tìm kiếm Product Manager tài năng để định hướng và phát triển các tính năng mới cho siêu ứng dụng thanh toán hàng đầu Việt Nam với 30+ triệu người dùng. Bạn sẽ làm việc với data, UX, engineering và business để tạo ra sản phẩm có impact lớn.',
      requirements: ['Ít nhất 3 năm kinh nghiệm PM ở môi trường tech', 'Hiểu biết sâu về lĩnh vực Fintech hoặc payments', 'Kỹ năng phân tích dữ liệu để ra quyết định', 'Tiếng Anh giao tiếp thành thạo'],
      benefits: ['ESOP', 'MacBook + màn hình 4K', 'Ngân sách team building hàng quý'],
      status: 'active',
      featured: true
    },
    {
      ...
      description: 'Bosch Vietnam tuyển Kỹ Sư Embedded Systems gia nhập đội ngũ R&D phát triển phần mềm nhúng cho các sản phẩm ô tô và IoT công nghiệp. Cơ hội làm việc với tiêu chuẩn quốc tế AUTOSAR và ISO 26262.',
      requirements: ['Tốt nghiệp kỹ thuật điện tử / cơ điện tử / CNTT', 'Thành thạo C/C++ cho embedded systems', 'Kiến thức về RTOS (FreeRTOS, Zephyr)', 'Ưu tiên có kinh nghiệm automotive'],
      benefits: ['Môi trường làm việc quốc tế', 'Cơ hội đào tạo tại Đức', 'Phụ cấp xe đưa đón'],
      status: 'active',
      featured: false
    },
    {
      ...
      description: 'Vinhomes tuyển Chuyên Viên Tư Vấn Bán Hàng cho các dự án căn hộ cao cấp. Bạn sẽ tiếp cận và tư vấn khách hàng tiềm năng, giới thiệu sản phẩm và chốt giao dịch. Thu nhập không giới hạn dựa trên hoa hồng.',
      requirements: ['Tốt nghiệp cao đẳng trở lên', 'Kỹ năng giao tiếp và thuyết phục tốt', 'Yêu thích công việc kinh doanh', 'Ngoại hình tốt, tác phong chuyên nghiệp'],
      benefits: ['Hoa hồng hấp dẫn', 'Đào tạo bài bản', 'Văn phòng tại các tòa nhà Vinhomes'],
      status: 'active',
      featured: false
    },
    {
      ...
      type: 'Full-time',
      level: 'Middle',
      tags: ['Y khoa', 'Chẩn đoán', 'Điều trị', 'Nội khoa', 'Bệnh viện quốc tế'],
      description: 'Vinmec International Hospital tuyển Bác Sĩ Đa Khoa làm việc tại Trung tâm Y tế quốc tế Hà Nội. Bạn sẽ thăm khám, chẩn đoán và điều trị cho bệnh nhân trong môi trường bệnh viện tiêu chuẩn JCI quốc tế.',
      requirements: ['Tốt nghiệp Đại học Y', 'Có chứng chỉ hành nghề bác sĩ đa khoa', 'Tiếng Anh giao tiếp tốt (ưu tiên)', 'Ít nhất 2 năm kinh nghiệm lâm sàng'],
      benefits: ['Bảo hiểm sức khỏe cao cấp cho cả gia đình', 'Đào tạo nước ngoài hàng năm', 'Môi trường quốc tế chuyên nghiệp'],
      status: 'active',
      featured: true
    },
    {
      ...
      type: 'Full-time',
      level: 'Junior',
      tags: ['Adobe Premiere', 'After Effects', 'Content', 'Social Media', 'YouTube', 'TikTok'],
      description: 'Yeah1 tìm kiếm Content Creator kiêm Video Editor đam mê sáng tạo nội dung cho các kênh YouTube và TikTok với hàng triệu subscribers. Bạn sẽ lên ý tưởng, quay và dựng video cho các dự án giải trí, du lịch, lifestyle.',
      requirements: ['Thành thạo Premiere Pro và After Effects', 'Hiểu biết về xu hướng mạng xã hội', 'Sáng tạo và bắt trend nhanh', 'Portfolio video ấn tượng'],
      benefits: ['Môi trường sáng tạo, trẻ trung', 'Thiết bị quay phim chuyên nghiệp', 'Cơ hội làm việc với KOL và nghệ sĩ nổi tiếng'],
      status: 'active',
      featured: false
    },
    {
      ...
      type: 'Part-time',
      level: 'Middle',
      tags: ['IELTS', 'Tiếng Anh', 'Giảng dạy', 'TESOL', 'CELTA', 'Academic English'],
      description: 'British Council Vietnam tuyển Giáo Viên Tiếng Anh chuyên luyện thi IELTS tại trung tâm. Bạn sẽ dạy các lớp nhỏ (tối đa 12 học viên), thiết kế giáo án và theo dõi tiến độ học tập của từng học viên.',
      requirements: ['Bằng cử nhân bất kỳ', 'Điểm IELTS 8.0+ hoặc chứng chỉ CELTA/DELTA/TESOL', 'Kinh nghiệm giảng dạy IELTS ít nhất 1 năm', 'Giao tiếp tiếng Anh như người bản ngữ'],
      benefits: ['Lịch dạy linh hoạt', 'Được đào tạo nghiệp vụ bởi British Council', 'Thư giới thiệu quốc tế'],
      status: 'active',
      featured: false
    },
    {
      ...
      type: 'Full-time',
      level: 'Middle',
      tags: ['Supply Chain', 'SAP', 'Excel', 'Logistics', 'Inventory', 'ERP', 'Demand Planning'],
      description: 'Samsung Electronics Vietnam tuyển Supply Chain Analyst phụ trách phân tích và tối ưu hóa chuỗi cung ứng cho nhà máy sản xuất điện thoại và thiết bị điện tử tại Việt Nam. Đây là cơ hội làm việc trong môi trường sản xuất quy mô lớn cấp độ toàn cầu.',
      requirements: ['Tốt nghiệp Logistics / Kinh tế / Kỹ thuật công nghiệp', 'Thành thạo SAP và Excel nâng cao', 'Kinh nghiệm phân tích dữ liệu chuỗi cung ứng', 'Tiếng Anh và/hoặc tiếng Hàn là lợi thế'],
      benefits: ['Làm việc với Samsung Hàn Quốc', 'Phụ cấp nhà ở và đi lại', 'Chương trình phúc lợi theo tiêu chuẩn tập đoàn toàn cầu'],
      status: 'active',
      featured: false
    }
  ];
