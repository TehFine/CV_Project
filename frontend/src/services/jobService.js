...
export const MOCK_JOBS = [
  {
    ...
    benefits: ['Lương cạnh tranh', 'Thưởng hiệu suất', 'Bảo hiểm sức khỏe', 'Laptop MacBook'],
    deadline: '2025-02-28',
    postedAt: '2025-01-20',
    views: 1243,
    applied: 87,
  ...
  },
  {
    ...
    description: 'Tham gia phát triển hệ thống thanh toán quy mô lớn, xử lý hàng triệu giao dịch mỗi ngày.',
    requirements: [
    ...
    benefits: ['Stock options', 'Remote flexible', 'Bảo hiểm premium', 'Du lịch hàng năm'],
    deadline: '2025-03-15',
    postedAt: '2025-01-18',
    views: 2156,
    applied: 134,
  ...
  },
  {
    ...
    description: 'Thiết kế trải nghiệm người dùng cho ứng dụng Grab với hàng triệu user tại Đông Nam Á.',
    requirements: [
    ...
    benefits: ['Grab credits hàng tháng', 'Flexible working', 'Training budget'],
    deadline: '2025-02-20',
    postedAt: '2025-01-22',
    views: 987,
    applied: 56,
  ...
  },
  {
    ...
    description: 'Dẫn dắt nhóm phát triển sản phẩm SaaS cho thị trường quốc tế.',
    requirements: [
    ...
    benefits: ['Cơ hội làm việc onsite nước ngoài', 'Đào tạo chứng chỉ quốc tế'],
    deadline: '2025-03-01',
    postedAt: '2025-01-19',
    views: 678,
    applied: 43,
  ...
  },
  {
    ...
    description: 'Xây dựng các mô hình ML cho hệ thống gợi ý sản phẩm và phát hiện gian lận.',
    requirements: ['MS/PhD về KHMT hoặc tương đương', '3+ năm kinh nghiệm ML', 'Thành thạo Python và SQL'],
  ...
  },
  {
    ...
    description: 'Quản lý và tối ưu hóa hạ tầng cloud phục vụ 70 triệu người dùng Zalo.',
    requirements: ['3+ năm DevOps/Cloud', 'Kinh nghiệm với AWS hoặc GCP', 'Terraform, Ansible'],
