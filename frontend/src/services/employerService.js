...
const mockJobs = [
  {
    ...
    description: 'Chúng tôi tìm kiếm Frontend Developer có kinh nghiệm với React, TypeScript...',
  ...
  },
  {
    ...
    description: 'Thiết kế giao diện người dùng cho các sản phẩm web và mobile...',
    location: 'Hà Nội',
    job_type: 'full-time',
    level: 'fresher',
    salary_min: 10000000,
...
const mockApplications = [
  {
    ...
    status: 'pending',
    cover_letter: 'Tôi rất quan tâm đến vị trí này và muốn đóng góp vào team...',
    applied_at: '2025-01-20T10:30:00Z',
    updated_at: '2025-01-20T10:30:00Z',
    seeker: { full_name: 'Nguyễn Văn An', email: 'nvan@email.com', avatar_url: null },
    resume: { title: 'CV Frontend Developer 2025', pdf_url: '#' },
    ai_score: { overall_score: 82.5, breakdown: { skills: 85, experience: 78, education: 88, keywords: 79 } },
  },
  {
    id: 'app_002',
    job_id: 'job_001',
    ...
    status: 'reviewing',
    cover_letter: 'Với 2 năm kinh nghiệm React, tôi tự tin có thể đáp ứng yêu cầu...',
    applied_at: '2025-01-21T14:20:00Z',
    updated_at: '2025-01-22T09:00:00Z',
    seeker: { full_name: 'Trần Thị Bích', email: 'tbich@email.com', avatar_url: null },
    resume: { title: 'Trần Thị Bích - ReactJS Dev', pdf_url: '#' },
    ai_score: { overall_score: 91.0, breakdown: { skills: 94, experience: 90, education: 85, keywords: 95 } },
  },
  {
    id: 'app_003',
    job_id: 'job_001',
    ...
    seeker: { full_name: 'Lê Minh Khoa', email: 'lmkhoa@email.com', avatar_url: null },
    resume: { title: 'CV - Lê Minh Khoa', pdf_url: '#' },
    ai_score: { overall_score: 74.0, breakdown: { skills: 72, experience: 76, education: 70, keywords: 78 } },
  },
  {
    id: 'app_004',
    job_id: 'job_001',
    ...
    seeker: { full_name: 'Phạm Quốc Dũng', email: 'pqdung@email.com', avatar_url: null },
    resume: { title: 'Resume_PhamQuocDung.pdf', pdf_url: '#' },
    ai_score: { overall_score: 52.0, breakdown: { skills: 48, experience: 55, education: 60, keywords: 45 } },
  },
  {
    id: 'app_005',
    job_id: 'job_002',
    ...
    seeker: { full_name: 'Hoàng Thu Hà', email: 'htha@email.com', avatar_url: null },
    resume: { title: 'CV Backend Developer - Hoàng Thu Hà', pdf_url: '#' },
    ai_score: { overall_score: 88.5, breakdown: { skills: 90, experience: 86, education: 88, keywords: 90 } },
  },
]
...
export const employerService = {
  ...
  async updateJob(id, data) {
    if (USE_MOCK) {
      ...
      mockJobs[idx] = { ...mockJobs[idx], ...data, updated_at: new Date().toISOString() }
      return mockJobs[idx]
    }
  ...
  async updateApplicationStatus(applicationId, status) {
    if (USE_MOCK) {
      ...
      if (app) { app.status = status; app.updated_at = new Date().toISOString() }
      return app
    }
    return api.patch(`/employer/applications/${applicationId}/status`, { status })
  },
}
