...
export default function Header() {
  ...
  // Chưa đăng nhập → redirect về login, kèm state để sau khi đăng nhập về employer
  const handleEmployerClick = (e) => {
    if (!isAuthenticated) {
      e.preventDefault();
      navigate("/login", {
        state: { from: "/employer/dashboard", hint: "employer" },
      });
    }
  };
        ...
        >
          ...
          >
            ...
            <Link
              ...
              style={{
                ...
                borderRadius: 8,
                fontSize: 14,
                fontWeight: isActive("/employer") ? 600 : 500,
                color: isActive("/employer") ? linkActiveColor : linkColor,
                textDecoration: "none",
                transition: "all 0.2s",
                backgroundColor: isActive("/employer")
                  ? scrolled || !isHome
                    ? "var(--primary-light)"
                    : "rgba(255,255,255,0.15)"
                  : "transparent",
                  ...
                  <div style={{ textAlign: "left" }}>
                    <div
                      style={{
                        ...
                        fontWeight: 600,
                        color:
                          scrolled || !isHome ? "var(--text-primary)" : "white",
                        lineHeight: 1.2,
                      }}
                    >
                    ...
                    >
                      {isEmployerPage ? "Nhà tuyển dụng" : "Ứng viên"}
                    </div>
                  </div>
                  <svg
                    width="14"
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={scrolled || !isHome ? "var(--text-primary)" : "white"}
              strokeWidth="2"
            >
              {menuOpen ? (
                <>
