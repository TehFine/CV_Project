...
const STEPS = [
  { num: "01", icon: "📝", title: "Đăng ký tài khoản", desc: "Tạo tài khoản nhà tuyển dụng miễn phí trong 2 phút với thông tin công ty." },
  { num: "02", icon: "📋", title: "Đăng tin tuyển dụng", desc: "Tạo tin tuyển dụng chi tiết với mô tả công việc và yêu cầu kỹ năng." },
  { num: "03", icon: "🤖", title: "AI lọc hồ sơ", desc: "Hệ thống AI tự động chấm điểm và xếp hạng CV theo mức độ phù hợp." },
  { num: "04", icon: "🎯", title: "Tuyển được người phù hợp", desc: "Liên hệ và phỏng vấn những ứng viên chất lượng nhất — nhanh hơn bao giờ hết." },
];
          ...
          {STEPS.map((step) => (
            <Card key={step.num} style={{ border: "1.5px solid var(--border)", borderRadius: 16, textAlign: "center", position: "relative", overflow: "hidden" }}>
              <CardContent style={{ padding: "28px 24px" }}>
                <div style={{ width: 56, height: 56, borderRadius: 16, backgroundColor: "#EEF2FF", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, margin: "0 auto 16px" }}>
                  {step.icon}
                </div>
