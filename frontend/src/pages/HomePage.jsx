...
import { Search, MapPin, Sparkles, ArrowRight, Building2, Users, FileEdit } from 'lucide-react'
      ...
      <section className="relative bg-gradient-to-br from-[#0F172A] via-[#1E3A6E] to-[#1549B8] overflow-hidden pt-20 pb-0">
        ...
        <div className="container-app relative pt-12 pb-0">
          ...
          <div className="inline-flex items-center gap-1.5 bg-violet-500/20 border border-violet-400/30 rounded-full px-3 py-1.5 mb-5">
            ...
            <span className="text-xs font-medium text-violet-200">Tích hợp AI chấm điểm CV thông minh</span>
          </div>
        ...
        <div className="container-app">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {JOB_CATEGORIES.map(cat => (
              <button key={cat.id} onClick={() => navigate(`/jobs?category=${cat.name}`)}
                ...
                <div>
                  ...
                  <div className="text-xs text-[#94A3B8] mt-0.5">{cat.count.toLocaleString()} việc</div>
                </div>
              </button>
            ))}
          </div>
      ...
      <section className="section bg-white border-t border-[#F1F5F9]">
        <div className="container-app">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {MOCK_JOBS.slice(0, 6).map((job, i) => <JobCard key={job.id} job={job} index={i} />)}
          </div>
        </div>
      </section>
        ...
        <div className="container-app">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {HOW_IT_WORKS.map((step, i) => (
              <div key={step.num}
                className="bg-white rounded-2xl border border-[#E2E8F0] p-6 text-center relative overflow-hidden animate-fade-in-up"
        ...
        <div className="container-app">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] rounded-2xl p-8 text-white">
              ...
              <Button variant="outline" asChild
                className="border-white/30 text-white bg-transparent hover:bg-white hover:text-[#0F172A] font-semibold">
